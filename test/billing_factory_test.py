...
class MyTestCase(unittest.TestCase):
    ...
    def test_payment_factory(self):
        ...
        self.assertEqual(printed,  "Payment for Water in the amount of 550 has been processed. You have used 9000 out of a max of 9000 credit remaining")
        self.assertIsInstance(credit, Credit)

        # check  name, amt, acc_num, routing_num, acc_name)
        user_input = '{"type":"check", "name":"Electric", "amt":550, "acc_num":44444, "routing_num":123456, "acc_name": "Generic"}'
        ...
        self.assertEqual(printed,  "Payment for Food in the amount of 550 Cash Payment setup for location: Generic Location")
